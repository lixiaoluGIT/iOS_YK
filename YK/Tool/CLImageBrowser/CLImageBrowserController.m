...
- (void)setOriginalImageView{
    ...
    [sourceImageView sd_setImageWithURL:[NSURL URLWithString:[self URLEncodedString:[NSString stringWithFormat:@"%@",_sourceArray[_currentIndex]]]] placeholderImage:[UIImage imageNamed:@"商品图"]];
...
//    UIImageView *imageV = _sourceArray[indexPath.item];
    [cell setImage:_imageArray[indexPath.row] placeholder:[UIImage imageNamed:@"商品详情图"]];
...
//    rectArray[_currentIndex];
    UIImageView *imageView = [[UIImageView alloc]init];
    [imageView sd_setImageWithURL:[NSURL URLWithString:[self URLEncodedString:rectArray[_currentIndex]]] placeholderImage:[UIImage imageNamed:@"首页商品图"]];
    if (cell) {
        FYTransitionHelper *animatorHelper = [[FYTransitionHelper alloc] initWithOriginalImageView:imageView frame:imageView.frame finalImageView:cell.imageView];
        _transitionHelper = animatorHelper;
    }
    [self goBack];
}
