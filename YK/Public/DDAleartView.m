...
- (void)setUpUI{
    ...
    self.aleartView = [[UIView alloc]initWithFrame:CGRectMake(20,-h, w-40, 400)];
    ...
    self.detailLabel.textColor = [UIColor colorWithHexString:@"637797"];
    self.detailLabel.textAlignment = NSTextAlignmentCenter;
    [self.aleartView addSubview:self.detailLabel];
    self.detailLabel.font = PingFangSC_Regular(13);
    ...
    self.noBtn.titleLabel.font = PingFangSC_Regular(17);
    ...
    self.yesBtn.titleLabel.font = PingFangSC_Regular(17);
...
- (void)setLayOut{
    ...
    [self.titleLabel mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.centerX.equalTo(weakSelf.aleartView.mas_centerX);
        make.top.equalTo(weakSelf.image.mas_bottom).offset(10);
    }];
    ...
    [self.line1 mas_remakeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(weakSelf.detailLabel.mas_bottom).offset(5);
        make.left.equalTo(@0);
...
- (void)setNewLayOut{
    ...
    [self.yesBtn mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.line1.mas_bottom);
        make.height.equalTo(@50);
        make.bottom.equalTo(self.aleartView.mas_bottom);
    ...
    [self.aleartView mas_remakeConstraints:^(MASConstraintMaker *make) {
        ...
        make.right.equalTo(@(-20));
        make.top.equalTo(weakSelf.image.mas_top);
        make.bottom.equalTo(weakSelf.yesBtn.mas_bottom);
    }];
}
- (void)no{
    self.noBlock();
