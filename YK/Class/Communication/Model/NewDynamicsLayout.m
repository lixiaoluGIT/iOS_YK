...
- (void)layoutDetail
{
    ...
    YYTextContainer * container = [YYTextContainer containerWithSize:CGSizeMake(SCREENWIDTH - 48, _model.isOpening ? CGFLOAT_MAX : 14 * lineCount + kDynamicsLineSpacing * (lineCount - 1))];
