...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPay_demotilele:(NSString *)title price:(NSString *)price order:(NSString *)orderid;

{
    //NSLog(@"%@-%@-%@",title,price,orderid);
    //订单标题，展示给用户
  ...
  //  NSString *orderno   = [NSString stringWithFormat:@"%ld",time(0)];
    ...
    [packageParams setObject: WXCallBack_Url        forKey:@"notify_url"];  //支付结果异步通知
